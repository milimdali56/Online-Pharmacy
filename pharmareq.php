...
if($rows > 0){
   ...
   ?>
    <div class= "card">
         ...
         <h4 class="card-title"><?php echo $med['id'] ;  ?>. <?php echo $med['name'] ;  ?><br>
         <?php echo $med['address'] ;?><br>
         <?php echo $med['phone_num'];?><br>
         </h4>
           <div class="card-body c text-center">
              
                <h6 class="card-text"> <?php echo $med['info'] ;?></h6>                            
