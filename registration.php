...
if (isset($_REQUEST['username'])){
	...
	$trn_date = date("Y-m-d H:i:s");
        $query = "INSERT into `user` (userRole, username, password, email, address, contactNum, trn_date)
VALUES ('user','$username', '".md5($password)."', '$email', '$address', '$contactNum', '$trn_date')";
